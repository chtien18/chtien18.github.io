...
<!-- Header row -->
<div style="display: flex; flex-wrap: wrap; font-weight: bold; border-bottom: 2px solid var(--main-border-color); padding-bottom: 0.5rem; margin-bottom: 1rem;">
  <div style="flex: 1; min-width: 140px; max-width: 160px; padding-right: 15px;">Metric</div>
  <div style="flex: 3; min-width: 250px;">Publication Details</div>
</div>
...
<ul style="list-style-type: none; padding-left: 0; margin-left: 0;">
  ...
  <li style="display: flex; flex-wrap: wrap; margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px dashed var(--main-border-color); word-wrap: break-word;">
    <div style="flex: 1; min-width: 140px; max-width: 160px; padding-right: 15px; margin-bottom: 0.5rem;">
      <a href="https://plu.mx/plum/a/?doi=10.1016%2Fj.mssp.2024.109118" class="plumx-plum-print-popup" data-site="plum" data-hide-when-empty="true">PlumX Metrics</a>
    </div>
  ...
  <!-- Item 2 -->
  <li style="display: flex; flex-wrap: wrap; margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px dashed var(--main-border-color); word-wrap: break-word;">
    <div style="flex: 1; min-width: 140px; max-width: 160px; padding-right: 15px; margin-bottom: 0.5rem; color: var(--text-muted-color);">•</div>
    <div style="flex: 3; min-width: 250px;">
  ...
  <li style="display: flex; flex-wrap: wrap; margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px dashed var(--main-border-color); word-wrap: break-word;">
    <div style="flex: 1; min-width: 140px; max-width: 160px; padding-right: 15px; margin-bottom: 0.5rem;">
      <a href="https://plu.mx/plum/a/?doi=10.1016%2Fj.mssp.2023.107911" class="plumx-plum-print-popup" data-site="plum" data-hide-when-empty="true">PlumX Metrics</a>
    </div>
    <div style="flex: 3; min-width: 250px;">
  ...
  <li style="display: flex; flex-wrap: wrap; margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px dashed var(--main-border-color); word-wrap: break-word;">
    <div style="flex: 1; min-width: 140px; max-width: 160px; padding-right: 15px; margin-bottom: 0.5rem;">
      <a href="https://plu.mx/plum/a/?doi=10.1007%2F978-3-030-76620-7_14" class="plumx-plum-print-popup" data-site="plum" data-hide-when-empty="true">PlumX Metrics</a>
    </div>
    <div style="flex: 3; min-width: 250px;">
  ...
  <li style="display: flex; flex-wrap: wrap; margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px dashed var(--main-border-color); word-wrap: break-word;">
    <div style="flex: 1; min-width: 140px; max-width: 160px; padding-right: 15px; margin-bottom: 0.5rem;">
      <a href="https://plu.mx/plum/a/?doi=10.1109%2Ficist.2017.7926499" class="plumx-plum-print-popup" data-site="plum" data-hide-when-empty="true">PlumX Metrics</a>
    </div>
    <div style="flex: 3; min-width: 250px;">
  ...
  <li style="display: flex; flex-wrap: wrap; margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px dashed var(--main-border-color); word-wrap: break-word;">
    <div style="flex: 1; min-width: 140px; max-width: 160px; padding-right: 15px; margin-bottom: 0.5rem; color: var(--text-muted-color);">•</div>
    <div style="flex: 3; min-width: 250px;">
      Nguyễn Chánh Nghiệm, Cao Hoàng Tiến, and Trần Nhựt Thanh. **"THIẾT KẾ QUADROTOR ĐỂ THU THẬP KHÔNG ẢNH."** <em>Tạp chí Khoa học Trường Đại học Cần Thơ</em> 32 (2014): 17-26. <a href="https://sj.ctu.edu.vn/ql/docgia/download/baibao-10559/03-CN-NGUYEN%20CHANH%20NGHIEM(17-26).pdf" target="_blank" rel="noopener">PDF Link</a>
    </div>
  </li>
